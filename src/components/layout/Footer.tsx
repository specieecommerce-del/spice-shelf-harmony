        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.facebook.com/speciesalimentos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-spice-warm-white/10 flex items-center justify-center hover:bg-spice-gold transition-colors">
                <Facebook size={18} />
              </a>
